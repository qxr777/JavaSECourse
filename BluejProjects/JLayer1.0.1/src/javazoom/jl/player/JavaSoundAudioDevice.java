...
public class JavaSoundAudioDevice extends AudioDeviceBase
{
	...
	private byte[]			byteBuf = new byte[4096];
        ...
        {
            super();
            System.err.println("Create java sound audio device");
        }
	...
	public void open(AudioFormat fmt) throws JavaLayerException
	{
		if (!isOpen())
		{
			...
			setAudioFormat(fmt);
                        System.err.println("Open impl");
			openImpl();
                        System.err.println("impl opened");
			setOpen(true);
		}
	}
	...
	protected void createSource() throws JavaLayerException
    {
        ...
        try
        {
            System.err.println("Before getLine");
            Line line = AudioSystem.getLine(getSourceLineInfo());
            System.err.println("After getLine");
            if (line instanceof SourceDataLine)
            {
                source = (SourceDataLine)line;
                //source.open(fmt, millisecondsToBytes(fmt, 2000));
                System.err.println("Open source " + source.getClass());
                source.open(fmt);
                /*
                ...
                source.start();
                System.err.println("Source started");
